...
let sum = {
    typeS : prompt ("Здравствуйте, какой тип сайта Вам интересен?", "лендинг, визитка, блог"),
    des   : prompt("Какой дизайн Вам лучше подойдёт?", "минимализм, индивидуальный, мой"),
    verst : prompt("Необходима адаптивная вёрстка?", "да, нет"),
...
if (sum.typeS === "лендинг" && sum.des=="минимализм" && sum.verst === "да") {
    ...
    alert(sum.sum7)
} else if (sum.typeS === "визитка" && sum.des=="мой" && sum.verst === "да") {
    alert(sum.sum8)
